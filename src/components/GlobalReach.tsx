...
export default function GlobalReach() {
  ...
  return (
    <Section id="global-reach" className="bg-bg-elevated relative overflow-hidden py-32 border-b border-border-subtle">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="bg-bg-surface border border-border-subtle hover:border-border-accent p-8 rounded-sm group transition-all text-center flex flex-col items-center hover:bg-bg-base"
            >
